              ...
              switch (affixType) {
                ...
                case 'VIEWPORT-UNBOTTOM':
                  ...
                  if (translate) style.inner = { transform: translate };
                    ...
                    style.inner = {
                      position: 'absolute',
                      top: dims.containerTop + dims.translateY
                    };
                  break;
              }
          ...
          },
          {
            ...
            value: function stickyPosition(force) {
              ...
              if ((this.affixedType != affixType || force) && affixType) {
                ...
                else this.sidebar.classList.add(this.options.stickyClass);
          ...
          },
          {
            ...
            value: function _appendResizeSensor(element) {
              ...
              wrapper.addEventListener('load', function(event) {
                ...
                target.contentDocument.defaultView.resizeTrigger =
                  target.resizeElement;
                target.contentDocument.defaultView.addEventListener(
                  'resize',
                  _this3._resizeListener
                );
              });
